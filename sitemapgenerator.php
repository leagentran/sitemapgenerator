...
*************************************************************/
define(_SCHEME_, $_SERVER['REQUEST_SCHEME']); define(_SITEURL_, $_SERVER["SERVER_NAME"]); $baseUrl = _SCHEME_.'://'._SITEURL_;
...
function Scan ($url)
{
    ...
    echo OUTPUT_FILE . "<div class='smark'><h1> FINISHED! <h1></div>" . NL;
?>
